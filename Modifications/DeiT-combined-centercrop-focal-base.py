...
from models.models_to_finetune import deit_small_patch16_224,deit_base_patch16_384,deit_base_patch16_224
...
model = deit_base_patch16_224(pretrained=True, use_top_n_heads=6,use_patch_outputs=False).cuda()
...
plt.plot(losses)
plt.savefig('Deit-combined_6heads_centercrop_focal_base.png')
# ## Testing
...
torch.save(model.state_dict(),'Deit-combined_6heads_centercrop_focal_base.ckpt')